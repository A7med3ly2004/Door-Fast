    ...
    public function show($id)
    {
        ...
        return response()->json([
            'order' => [
                ...
                'send_to_phone2' => $order->send_to_phone2 ?? null,
                ...
                'client'           => $order->client ? ['name' => $order->client->name, 'phone' => $order->client->phone, 'phone2' => $order->client->phone2, 'code' => $order->client->code] : null,
