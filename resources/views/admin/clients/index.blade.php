...
@section('content')
    ...
    <div class="modal-overlay" id="modal-edit-client">
        <div class="modal modal-lg">
            <div class="modal-header">
                <h3>تعديل بيانات العميل</h3><button class="btn-close"
    ...
    <script>
        ...
        async function loadClients(page = 1) {
            ...
            try {
                ...
                <td style="text-align: center;"><code style="color:var(--yellow)">${c.code}</code></td>
                ...
                <td style="text-align: center;font-size:12px;color:var(--text-muted)">${c.orders?.[0] ? formatDate(c.orders[0].created_at) : '—'}</td>
