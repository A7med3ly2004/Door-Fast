...
<div class="kpi-grid" id="kpi-grid">
    <div class="kpi-card" id="kpi-orders"><div class="kpi-label">إجمالي الطلبات اليوم</div><div class="kpi-value" id="v-orders">—</div></div>
    <div class="kpi-card green" id="kpi-completed"><div class="kpi-label">مُوصَّلة اليوم</div><div class="kpi-value" id="v-completed">—</div></div>
    <div class="kpi-card" style="--kpi-color:var(--yellow)"><div class="kpi-label">معلقة اليوم</div><div class="kpi-value" id="v-pending">—</div></div>
    <div class="kpi-card red"><div class="kpi-label">ملغاة اليوم</div><div class="kpi-value" id="v-cancelled">—</div></div>
    <div class="kpi-card blue"><div class="kpi-label">إيرادات اليوم</div><div class="kpi-value" id="v-daily">—</div><div class="kpi-sub">ج.م</div></div>
    <div class="kpi-card blue"><div class="kpi-label">إيرادات الشهر</div><div class="kpi-value" id="v-monthly">—</div><div class="kpi-sub">ج.م</div></div>
    <div class="kpi-card"><div class="kpi-label">إجمالي العملاء</div><div class="kpi-value" id="v-clients">—</div></div>
</div>
...
<div class="grid-2" style="gap:20px; margin-bottom:20px">
    ...
    <div class="card">
        <div class="card-title">🕐 آخر الأنشطة <span style="font-size:11px;color:var(--text-muted);font-weight:400">(يتجدد تلقائياً)</span></div>
...
<div class="card" style="margin-bottom:20px">
    <div class="card-title">🧾 آخر 5 طلبات <span style="font-size:11px;color:var(--text-muted);font-weight:400">(يتجدد كل 30 ثانية)</span></div>
    <div class="table-wrap">
        <table>
            <thead>
                <tr>
                    <th>رقم الطلب</th><th>العميل</th><th>كول سنتر</th><th>المندوب</th><th>الإجمالي</th><th>الحالة</th><th>التاريخ</th>
                </tr>
            </thead>
...
<div class="grid-2" style="gap:20px">
    <div class="card">
        ...
        <div class="table-wrap">
            <table>
                <thead><tr><th>المندوب</th><th>مُوصَّلة</th><th>الإيراد</th></tr></thead>
    ...
    try {
        ...
        body.innerHTML = !data.orders.length
            ...
            : data.orders.map(o => `<tr>
                ...
                <td>${o.client}</td><td>${o.callcenter}</td><td>${o.delivery}</td>
