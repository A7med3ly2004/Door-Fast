...
<div class="card" style="margin-bottom:20px">
    <div class="filter-bar" style="display: flex; flex-wrap: nowrap; align-items: flex-end; gap: 8px; width: 100%;">
        <div style="width: 15%;">
            ...
            <input type="text" id="filter-search" class="form-control" placeholder="رقم الطلب / كود العميل / الهاتف"
...
<script>
    ...
    window.resetFilters = function () {
        ...
        if (window.loadOrders) window.loadOrders(1);
    }
    ...
    window.renderPagination = function (lastPage, current) {
