...
<body>
    ...
    <table style="width: 100%; margin-bottom: 30px; border-bottom: 2px solid #e2e8f0; padding-bottom: 10px;">
        <tr>
            ...
            <td style="width: 40%; text-align: center;">
                <h1 style="color: #a10303ff; margin: 0; font-size: 28px;">Door Fast</h1>
    ...
    <div style="width: 60%; float: right;">
        <table class="totals-table">
            ...
            <tr class="grand-total">
                <td class="value"><span dir="ltr">{{ number_format($order->total, 2) }} ج</span></td>
    ...
    <div class="footer">
        <p>Door Fast {{ $ar('شكراً لتعاملكم مع') }}</p>
    </div>
