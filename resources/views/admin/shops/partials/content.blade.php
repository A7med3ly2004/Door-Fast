...
<div class="card" style="margin-bottom:20px">
    <div class="filter-bar">
        <input type="text" id="filter-search" class="form-control" placeholder="بحث بالاسم أو الكود"
...
<div class="card" style="padding:0;position:relative">
    ...
    <div class="table-wrap">
        <table>
            ...
            <tbody id="shops-body">
                <tr>
                    <td colspan="7" style="text-align:center;color:var(--text-muted);padding:40px">جاري التحميل...</td>
                </tr>
            </tbody>
        </table>
    </div>
        ...
        <div class="modal-body">
            <div class="filter-bar" style="margin-bottom:16px">
                ...
                <button class="btn btn-primary"
                    onclick="loadShopDetails(document.getElementById('view-shopid').value)">تحديث</button>
            </div>
            <input type="hidden" id="view-shopid">
            <div id="shop-details-body">
    ...
    async function loadShopDetails(id) {
        ...
        try {
            ...
            <div class="table-wrap">
                ...
                <tbody>${s.top_items.length ? s.top_items.map(i => `<tr><td style="text-align: center;">${i.item_name}</td><td>${i.total_qty}</td><td>${parseFloat(i.total_value).toFixed(2)} ج</td></tr>`).join('') : '<tr><td colspan="3" style="text-align:center;color:var(--text-muted)">لا بيانات</td></tr>'}
                </tbody></table>
            </div>
        `;
