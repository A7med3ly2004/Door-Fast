<div class="section-header">
    ...
    <div style="display:flex;gap:10px">
        ...
        <button class="btn btn-success" onclick="exportShopsExcel()" style="background:#217346;color:#fff;">تصدير
            Excel</button>
    </div>
</div>
...
<div class="card" style="margin-bottom:20px">
    <div class="filter-bar" style="align-items: flex-end;">
        <div>
            ...
            <input type="text" id="filter-search" class="form-control" placeholder="بحث بالاسم أو الكود أو رقم الهاتف"
...
<div class="modal-overlay" id="modal-add-shop">
    <div class="modal">
        <div class="modal-header">
            <h3>إضافة متجر</h3><button class="btn-close" onclick="closeModal('modal-add-shop')">✕</button>
        </div>
        ...
        <div class="modal-body">
            ...
            <div class="form-row">
                <div class="form-group"><label class="form-label">الاسم *</label><input id="edit-name" type="text"
                        class="form-control"></div>
                <div class="form-group"><label class="form-label">الكود</label><input id="edit-code" type="text"
            ...
            <div class="form-row">
                <div class="form-group"><label class="form-label">الهاتف الأساسي</label><input id="edit-phone"
                        type="text" class="form-control" placeholder="الهاتف الرئيسي"></div>
            ...
            <div class="form-row">
                <div class="form-group"><label class="form-label">هاتف 3</label><input id="edit-phone3" type="text"
                        class="form-control" placeholder="اختياري"></div>
                <div class="form-group"><label class="form-label">هاتف 4</label><input id="edit-phone4" type="text"
                        class="form-control" placeholder="اختياري"></div>
            </div>
        </div>
        <div class="modal-footer">
