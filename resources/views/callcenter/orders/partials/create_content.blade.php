...
<script>
    ...
    function saveDrafts() {
        ...
        document.querySelectorAll('.order-card').forEach(card => {
            ...
            drafts.push({
                ...
                delivery: document.getElementById(id + '-delivery')?.value || '', stOpen: document.getElementById(id + '-sendto')?.classList.contains('open') || false, stPhone: document.getElementById(id + '-st-phone')?.value || '', stPhone2: document.getElementById(id + '-st-phone2')?.value || '', stAddrWrap: document.getElementById(id + '-st-addr-wrap')?.innerHTML || '', stAddrVal: document.getElementById(id + '-st-addr-txt')?.value || '', stCode: document.getElementById(id + '-st-code')?.value || '', stName: document.getElementById(id + '-st-name')?.value || '', stClientId: document.getElementById(id + '-st-client-id')?.value || '', stClientFound: document.getElementById(id + '-st-client-found')?.value || '0',
    ...
    async function clearCard(cardId) {
        ...
        ['phone', 'phone2', 'code', 'name', 'st-phone', 'st-phone2', 'st-name', 'st-code', 'notes'].forEach(f => { if (document.getElementById(cardId + '-' + f)) document.getElementById(cardId + '-' + f).value = ''; }); document.getElementById(cardId + '-client-id').value = ''; document.getElementById(cardId + '-client-found').value = '0'; document.getElementById(cardId + '-fee').value = '0'; document.getElementById(cardId + '-disc').value = '0'; document.getElementById(cardId + '-items').innerHTML = ''; resetAddressSection(cardId, false); calcTotals(cardId); for (let i = 0; i < 3; i++) addItemRow(cardId); saveDrafts();
    }
