...
<div class="section-header">
    ...
    <div style="display:flex;gap:8px;flex-wrap:wrap;">
        ...
        <button class="btn" onclick="openReceiveModal()" style="background:#059669;color:#fff;">ايصال استلام من
            مندوب</button>
    </div>
</div>
...
<div class="modal-overlay" id="modal-cc-pay">
    <div class="modal">
        ...
        <div class="modal-body">
            <div id="pay-global-error"
                style="background:var(--red-light);color:var(--red-dark);padding:10px;border-radius:8px;margin-bottom:12px;display:none;font-size:12px;">
            </div>
            <div class="form-group">
                ...
                <div class="error-text" id="pay-delivery-id-error"
                    style="color:var(--red);font-size:11px;margin-top:4px;"></div>
            </div>
            <div class="form-group">
                ...
                <div style="display:flex;">
                    ...
                    <span
                        style="background:var(--input-bg);padding:8px 11px;border-radius:8px 0 0 8px;font-size:12px;color:var(--text-muted);border:1px solid var(--border);border-right:none;">ج.م</span>
                </div>
                <div class="error-text" id="pay-amount-error" style="color:var(--red);font-size:11px;margin-top:4px;">
                </div>
            </div>
            <div class="form-group">
                <label for="pay-date" class="form-label">التاريخ <span
                        style="color:var(--text-muted);font-weight:400;font-size:10px;">(اختياري)</span></label>
                <input type="date" id="pay-date" class="form-control" max="{{ now()->toDateString() }}">
                <div class="error-text" id="pay-date-error" style="color:var(--red);font-size:11px;margin-top:4px;">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="error-text" id="pay-description-error"
                    style="color:var(--red);font-size:11px;margin-top:4px;"></div>
            </div>
        </div>
    ...
    <div class="modal">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="error-text" id="rcv-delivery-id-error"
                    style="color:var(--red);font-size:11px;margin-top:4px;"></div>
            </div>
            <div class="form-group">
                <label for="rcv-amount" class="form-label">المبلغ <span style="color:var(--red)">*</span></label>
                <div style="display:flex;">
                    <input type="number" id="rcv-amount" class="form-control" placeholder="0.00" min="0.01" step="0.01"
                        max="9999999.99" style="border-radius:0 8px 8px 0;flex:1;">
                    <span
                        style="background:var(--input-bg);padding:8px 11px;border-radius:8px 0 0 8px;font-size:12px;color:var(--text-muted);border:1px solid var(--border);border-right:none;">ج.م</span>
                </div>
                <div class="error-text" id="rcv-amount-error" style="color:var(--red);font-size:11px;margin-top:4px;">
                </div>
            </div>
            <div class="form-group">
                <label for="rcv-date" class="form-label">التاريخ <span
                        style="color:var(--text-muted);font-weight:400;font-size:10px;">(اختياري)</span></label>
                <input type="date" id="rcv-date" class="form-control" max="{{ now()->toDateString() }}">
                <div class="error-text" id="rcv-date-error" style="color:var(--red);font-size:11px;margin-top:4px;">
                </div>
            </div>
            <div class="form-group">
                <label for="rcv-description" class="form-label">ملاحظة <span
                        style="color:var(--text-muted);font-weight:400;font-size:10px;">(اختياري)</span></label>
                <textarea id="rcv-description" class="form-control" rows="2" maxlength="500"
                    placeholder="وصف مختصر..."></textarea>
                <div class="error-text" id="rcv-description-error"
                    style="color:var(--red);font-size:11px;margin-top:4px;"></div>
            </div>
        </div>
        <div class="modal-footer" style="border-top:0;">
            ...
            <button class="btn" id="rcv-submit-btn" onclick="submitReceive()" style="background:#059669;color:#fff;">
                <span id="rcv-submit-spinner" class="spin"
                    style="display:none;width:14px;height:14px;border-width:2px;"></span>
                تأكيد الاستلام
            </button>
        </div>
