...
<style>
    ...
    /* Force buttons visibility on mobile */
    .party-row button {
        white-space: nowrap;
        ...
        cachedOrders.forEach(order => {
            ...
            `;
                ...
                <div class="single-party-info">
                    ...
                    <div class="party-row"><span class="icon">📞</span> <a href="tel:${clientPhone}" class="phone-link" onclick="event.stopPropagation()">${clientPhone}</a>${order.client?.phone2 ? ` / <a href="tel:${order.client.phone2}" class="phone-link" onclick="event.stopPropagation()">${order.client.phone2}</a>` : ''}</div>
    ...
    function openOrderModal(orderId) {
        ...
        <div class="modal-body">
            ...
            <div class="info-group" style="margin-top:15px; display:flex; justify-content:space-between; padding:12px; background:#f8fafc; border-radius:8px; border:1px solid #e2e8f0;">
                <span style="font-weight:700; color:#475569;">عدد الأصناف:</span>
                <span style="font-weight:bold; font-size:16px;">${itemsCount}</span>
            </div>
