...
<head>
    ...
    <title>500 - خطأ في السيرفر | دوور فاست</title>
    ...
    <style>
        *, *::before, *::after {
        ...
        .error-icon {
            font-size: 60px;
            margin-bottom: 20px;
            animation: fadeInDown 0.6s ease 0.1s both, shake 1.5s ease 0.8s;
        }
...
<body>
    <div class="container">
        ...
        <p class="error-message">
            عذراً، حدث خطأ غير متوقع من جانبنا.<br>
            فريقنا يعمل على حل المشكلة. يرجى المحاولة مجدداً لاحقاً.
        </p>
